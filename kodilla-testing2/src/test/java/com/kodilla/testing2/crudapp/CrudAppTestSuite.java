...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://marcinp55.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("marcinp55@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("kodillaPass");
